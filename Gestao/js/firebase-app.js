...
function normalizeManagedUsers(users){
  ...
  const ricardo = { username: 'pica.fern', email: 'pica.fern@gmail.com', password: '', role: 'master_admin' };
...
window.startApp = function(sessionOrRole, maybeUsername){
  ...
  currentRole = session.role || 'master_admin';
  currentUsername = session.username || 'user';
